...
class PathCell: UITableViewCell {
    ...
    // 승수한테 무러보기
    @objc func goToDetailPath() {
        guard let nextVC = UIStoryboard(name: "Schedule", bundle: nil).instantiateViewController(identifier: "ShowPathDetailViewController") as? ShowPathDetailViewController else { return }
